...
FVG_SETTINGS = {
    ...
    'timeframes': ['1h', '4h', '1d', '1w'], # какие ТФ анализировать ['15m', '30m', '1h', '4h', '1d', '1w']
}
...
TRENDLINE_ANALYSIS_SETTINGS = {
    'enabled': True,
    'timeframes': ['5m', '15m', '30m', '1h', '4h', '1d'],  # какие ТФ анализировать
...
VIP_PUMP_SETTINGS = {
    ...
    'indicators': {
        ...
        'senior_tf': {'enabled': False, 'min_alignment': 70},
        ...
        'confluence': {'enabled': False, 'min_strength': 50},
        'tf_alignment': {'enabled': False, 'min_percentage': 70},
        'fibonacci': {
            'enabled': True,
...
ENTRY_ZONES_GUARANTEED = {
    ...
    'long': {
        ...
        'lookback': 192,             # ~48 часов на 15м (200 - offset)
